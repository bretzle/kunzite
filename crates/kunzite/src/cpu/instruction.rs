...
impl Instruction {
	...
	pub fn size(&self) -> u16 {
		match self {
			...
			Instruction::Or8(_) => 2,
			Instruction::Cp8(_) => 2,
			Instruction::AddSp8(_) => todo!("{:?}", self),
			Instruction::Daa => 1,
			Instruction::Scf => 1,
			Instruction::Cpl => 1,
			Instruction::Ccf => 1,
			...
			Instruction::Rrca => 1,
			Instruction::Rra => 1,
			Instruction::StoreImm16AddrSp(_) => todo!("{:?}", self),
			Instruction::AddHl(_) => todo!("{:?}", self),
			Instruction::Ret(_) => 1,
			Instruction::Reti => 1,
			Instruction::Di => 1,
			Instruction::Ei => 1,
			...
			Instruction::JpHl => 1,
			Instruction::Rst(_) => 1,
			Instruction::LdHlSp8(_) => todo!("{:?}", self),
			Instruction::LdSpHl => todo!("{:?}", self),
	...
	pub fn ticks(&self) -> u8 {
		match self {
			...
			Instruction::StoreAAtAddress(_) => todo!(),
			Instruction::LoadAFromAddress(_) => todo!(),
			// 0xCB prefix
